...
public class UpdateTaxRateDialog extends JDialog{
    
    private String initPriceString;
    private String finalPriceString;
    private String dateString;
    private String taxRateString;
    
    public UpdateTaxRateDialog(JFrame parent, String initPriceString, String finalPriceString, String dateString, String taxRateString){
        super(parent, "Создание процентной ставки", true);
        
        this.initPriceString = initPriceString;
    ...
    private JPanel createGUI(){
        ...
        initPriceField.setText(initPriceString);
        ...
        finalPriceField.setText(finalPriceString);
        ...
        taxRateField.setText(taxRateString);
        ...
        BoxlayoutUtils.setGroupAligmentY(
                new JComponent[]{initPriceField, initPriceField, initPriceLabel, initPriceLabel},
                    CENTER_ALIGNMENT);
    ...
    class OkButtonListener extends MouseAdapter{
        ...
        public void mouseClicked(MouseEvent e) {
            ...
            try(Connection c = ConnectionManager.open()){
                int res = new TaxRatesDAO().update(new Object[]{
                    initPriceString,
                    finalPriceString,
                    dateString,
                    taxRateString
                ...
                JOptionPane.showMessageDialog(UpdateTaxRateDialog.this, "Было затронуто "+res+" строк!");
                dispose();
            }catch(Exception ex){
                JOptionPane.showMessageDialog(UpdateTaxRateDialog.this, ex.getMessage());
            }
        }
