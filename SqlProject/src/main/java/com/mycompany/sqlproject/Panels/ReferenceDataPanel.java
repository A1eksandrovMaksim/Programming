...
import com.mycompany.sqlproject.AuxiliaryDialogues.TaxRates.CreateTaxRateDialog;
import com.mycompany.sqlproject.AuxiliaryDialogues.TaxRates.UpdateTaxRateDialog;
import com.mycompany.sqlproject.DAOs.AddressesDAO;
...
public class ReferenceDataPanel extends JPanel{
    ...
    public ReferenceDataPanel(MainFrame mainFrame, DataType dataType){
    ...
    private class CreateButtonListener implements ActionListener{
        ...
        public void actionPerformed(ActionEvent e) {
            switch(dataType){
                case TaxRates -> new CreateTaxRateDialog(mainFrame);
            }
            setTableData();
            GUITools.alignTable(table);
        }
    ...
    private class UpdateButtonListener implements ActionListener{
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            switch(dataType){
                case TaxRates -> new UpdateTaxRateDialog(mainFrame,
        ...
        public void actionPerformed(ActionEvent e) {
            try{
                for(int rowId : table.getSelectedRows()){
                    switch(dataType){
                        case TaxRates -> new TaxRatesDAO().delete(new Object[]{table.getValueAt(rowId, 0).toString(),
    ...
    public void setTableData(){
        try{
            ObjectDAO dao = switch(dataType){
                case DataType.TaxRates -> new TaxRatesDAO();
                case DataType.Addresses -> new AddressesDAO();
                default -> new TaxRatesDAO();
            };
